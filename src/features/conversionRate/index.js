...
function ConversionRate() {
    ...
    const loadData = async () => {
        ...
        try {
            ...
            // Aggregate by user across the date range
            const byUser = {}
            data.forEach(item => {
    ...
    const sortedRows = useMemo(() => {
        ...
        return [...rows].sort((a, b) => {
            ...
            } else if (sortKey === 'connectAccept') {
                av = a.connect ? a.accept / a.connect : 0
                bv = b.connect ? b.accept / b.connect : 0
            } else if (sortKey === 'acceptPublish') {
                av = a.accept ? a.publish / a.accept : 0
                bv = b.accept ? b.publish / b.accept : 0
            } else if (sortKey === 'publishUpload') {
                av = a.publish ? a.upload / a.publish : 0
                bv = b.publish ? b.upload / b.publish : 0
            } else {
